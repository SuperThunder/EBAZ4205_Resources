...
class _gpgme_key_sig(_object):
    ...
    __swig_setmethods__["_class"] = _gpgme._gpgme_key_sig__class_set
    __swig_getmethods__["_class"] = _gpgme._gpgme_key_sig__class_get
    if _newclass:
        _class = _swig_property(_gpgme._gpgme_key_sig__class_get, _gpgme._gpgme_key_sig__class_set)
...
class _gpgme_new_signature(_object):
    ...
    __swig_setmethods__["_class"] = _gpgme._gpgme_new_signature__class_set
    __swig_getmethods__["_class"] = _gpgme._gpgme_new_signature__class_get
    if _newclass:
        _class = _swig_property(_gpgme._gpgme_new_signature__class_get, _gpgme._gpgme_new_signature__class_set)
